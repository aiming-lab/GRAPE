...
def run_maniskill2_eval_single_episode(
    ...
    while 'success' not in episode_results or 'failure' not in episode_results or (num_fail+num_success)<5:
        ...
        final_traj_score_2=inner_score+0.01*-math.log(external_score_2)+success_score
        ...
        if(success=='success'):
            ...
            'data': total_data,
            'images': images,
            'npy_path': os.path.join(episode_dir, f"{success}_episode_{obj_episode_id}_{num_success}.npy")
        }
            ...
            'data': total_data,
            'images': images,
            'npy_path': os.path.join(episode_dir, f"{success}_episode_{obj_episode_id}_{num_fail}.npy")
            }
